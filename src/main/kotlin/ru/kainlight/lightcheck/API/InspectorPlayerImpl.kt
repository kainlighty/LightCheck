...
internal data class InspectorPlayerImpl(override val player: Player, override val checkedPlayer: CheckedPlayer, override val previousLocation: Location) : InspectorPlayer {
